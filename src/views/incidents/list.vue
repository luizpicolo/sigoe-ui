      ...
      <main class="flex-1 p-6">
        ...
        <div class="bg-white rounded-md shadow p-4 mb-6">
          ...
          <Button 
            ...
            to="/ocorrencias/ocorrencias/novo"
          >
        ...
        <div class="bg-white rounded-md shadow overflow-hidden">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody v-for="(value, i) in 10" class="bg-white divide-y divide-gray-200">
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ i }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">30/04/2025</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Luiz Fernando Picolo</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Curso Técnico em Informática</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <Button customClass="w-full bg-green-600 hover:bg-green-700 focus:ring-green-500" to="/ocorrencias/ocorrencias/visualizar/9">
