          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody v-for="(value, i) in 5" class="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">20251301201A</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Turma C</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Campus</td>
